@extends('report.web.layouts.app')
...
@section('content')
  <main class="main">
    ...
    <section id="hero" class="hero section">
      <div class="hero-bg">
        <img src="{{asset('report/assets/img/hero-bg-light.webp')}}" alt="">
      </div>
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <img src="{{asset('report/assets/img/website/report.png')}}" class="img-fluid hero-img" alt="" data-aos="zoom-out" data-aos-delay="300">
        </div>
      </div>
          ...
          <div class="col-lg-5">
            ...
            <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="tab-pane fade active show" id="features-tab-1">
                <img src="{{asset('report/assets/img/website/daily-report.webp')}}" alt="" class="img-fluid">
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="{{asset('report/assets/img/website/accountibility1.jpg')}}" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4 justify-content-between features-item">
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
            <img src="{{asset('report/assets/img/website/accountibility.jpg')}}" class="img-fluid" alt="">
          </div>
